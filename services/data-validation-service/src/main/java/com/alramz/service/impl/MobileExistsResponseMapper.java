...
@Component
public class MobileExistsResponseMapper implements ValidationResponseMapper {
    ...
    public ValidationResponse map(ETradeResponse externalResponse, ValidationRequest request) {
        ...
        String message = exists ? "Mobile number already exists" : "Mobile number does not exist";
